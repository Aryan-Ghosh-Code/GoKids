...
export const metadata: Metadata = {
  title: "Workshops for Kids — Go Kids India",
  description:
    "Browse expert-led workshops in Coding, Maths, Science, and more — designed for Indian children aged 7–14.",
  openGraph: {
    title: "Workshops for Kids — Go Kids India",
    description: "Expert-led workshops for kids aged 7–14.",
    images: ["/images/workshops-banner.jpg"],
  },
};

// ─── Hero ─────────────────────────────────────────────────────────────────────
function ChildrenWorkshopsHero() {
  return (
    <section className="relative w-full overflow-hidden" style={{ minHeight: 340 }}>
      <Image
        src="/images/workshops-banner.jpg"
        alt="Go Kids Workshops for Children"
        fill
        priority
        sizes="100vw"
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default async function ChildrenWorkshopsPage() {
  const workshops = await getWorkshops({ audienceType: "children" });
